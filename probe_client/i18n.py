...
TRANSLATIONS = {
    "en": {
        ...
        "act.managed_remote": "This probe is fully managed from the central server. Reset and maintenance are performed remotely by the administrator.",
    ...
    "it": {
        ...
        "act.managed_remote": "Questa sonda è gestita interamente dal server centrale. Reset e manutenzione vengono eseguiti da remoto dall'amministratore.",
